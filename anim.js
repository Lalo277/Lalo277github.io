...
var lyricsData = [
  { text: "Hola, ¿qué tal, princesa?", time: 6-4 },
  { text: "Te quería saludar, también felicitar", time: 8-4 },
  { text: "No lo puedo evitar, sé que no es tu cumpleaños", time: 12-4 },
  { text: "Pero te felicito por lo hermosa que estás", time: 16-4 },
  { text: "Nunca había conocido una mujer tan centrada", time: 21-4  },
  { text: "Tan inteligente, buena y bien educada", time: 25-4  },
  { text: "Con forma de ser maravillosa de plano", time: 29-4  },
  { text: "Mi niña, tú eres toda una diosa", time: 33-4 },
  { text: "Pero te lo confieso", time: 35-4 },
  { text: "Entre tanta belleza, hay un pequeño detalle", time: 40-4  },
